...
def progress():
    ...
    if has_sufficient_wordcloud_data:
        ...
        stop_words = set([
            'the', 'and', 'is', 'in', 'it', 'of', 'to', 'a', 'for', 'on', 'with', 'as', 'at', 'by', 'an', 'be', 'this', 'that', 'from', 'or', 'are', 'was', 'but', 'not', 'have', 'has', 'had', 'they', 'you', 'i', 'we', 'he', 'she', 'his', 'her', 'their', 'our', 'my', 'your', 'so', 'if', 'do', 'did', 'does', 'can', 'will', 'just', 'about', 'me', 'what', 'when', 'which', 'who', 'how', 'all', 'no', 'out', 'up', 'down', 'into', 'more', 'than', 'then', 'them', 'were', 'been', 'would', 'could', 'should', 'also', 'because', 'too', 'very', 'get', 'got', 'go', 'going', 'one', 'now', 'over', 'after', 'before', 'off', 'even', 'still', 'only', 'see', 'such', 'where', 'why', 'these', 'those', 'each', 'other', 'some', 'any', 'every', 'much', 'many', 'most', 'few', 'lot', 'lots', 'may', 'might', 'must', 'like', 'want', 'needs', 'need', 'make', 'made', 'back', 'again', 'new', 'old', 'first', 'last', 'time', 'day', 'days', 'week', 'weeks', 'month', 'months', 'year', 'years', 'today', 'tomorrow', 'yesterday', 'now', 'soon', 'late', 'early', 'never', 'always', 'sometimes', 'often', 'usually', 'once', 'twice', 'next', 'previous', 'another', 'same', 'different', 'right', 'left', 'here', 'there', 'home', 'work', 'school', 'place', 'thing', 'things', 'way', 'ways', 'life', 'lives', 'person', 'people', 'man', 'woman', 'child', 'children', 'friend', 'friends', 'family', 'families', 'parent', 'parents', 'mother', 'father', 'mom', 'dad', 'sister', 'brother', 'son', 'daughter', 'husband', 'wife', 'partner', 'boyfriend', 'girlfriend', 'teacher', 'student', 'class', 'classes', 'group', 'groups', 'team', 'teams', 'member', 'members', 'leader', 'lead', 'follow', 'following', 'followed', 'find', 'found', 'lose', 'lost', 'give', 'gave', 'take', 'took', 'keep', 'kept', 'let', 'lets', 'put', 'set', 'run', 'ran', 'walk', 'walked', 'move', 'moved', 'stop', 'stopped', 'start', 'started', 'end', 'ended', 'begin', 'began', 'finish', 'finished', 'try', 'tried', 'use', 'used', 'work', 'worked', 'play', 'played', 'read', 'reading', 'write', 'wrote', 'writing', 'talk', 'talked', 'say', 'said', 'tell', 'told', 'ask', 'asked', 'answer', 'answered', 'show', 'showed', 'see', 'saw', 'look', 'looked', 'watch', 'watched', 'hear', 'heard', 'listen', 'listened', 'feel', 'felt', 'think', 'thought', 'know', 'knew', 'understand', 'understood', 'remember', 'forgot', 'forget', 'forgotten', 'learn', 'learned', 'teach', 'taught', 'help', 'helped', 'need', 'needed', 'want', 'wanted', 'love', 'loved', 'like', 'liked', 'hate', 'hated', 'enjoy', 'enjoyed', 'prefer', 'preferred', 'hope', 'hoped', 'wish', 'wished', 'plan', 'planned', 'decide', 'decided', 'choose', 'chose', 'chosen', 'change', 'changed', 'stay', 'stayed', 'leave', 'left', 'arrive', 'arrived', 'come', 'came', 'go', 'went', 'return', 'returned', 'visit', 'visited', 'live', 'lived', 'die', 'died', 'grow', 'grew', 'grown', 'buy', 'bought', 'sell', 'sold', 'pay', 'paid', 'spend', 'spent', 'save', 'saved', 'cost', 'costs', 'costed', 'win', 'won', 'lose', 'lost', 'send', 'sent', 'receive', 'received', 'open', 'opened', 'close', 'closed', 'turn', 'turned', 'start', 'started', 'stop', 'stopped', 'wait', 'waited', 'meet', 'met', 'call', 'called', 'visit', 'visited', 'travel', 'traveled', 'drive', 'drove', 'driven', 'ride', 'rode', 'ridden', 'fly', 'flew', 'flown', 'swim', 'swam', 'swum', 'cook', 'cooked', 'eat', 'ate', 'eaten', 'drink', 'drank', 'drunk', 'sleep', 'slept', 'wake', 'woke', 'woken', 'dream', 'dreamed', 'dreamt', 'sing', 'sang', 'sung', 'dance', 'danced', 'draw', 'drew', 'drawn', 'paint', 'painted', 'build', 'built', 'create', 'created', 'make', 'made', 'fix', 'fixed', 'break', 'broke', 'broken', 'clean', 'cleaned', 'wash', 'washed', 'dry', 'dried', 'cut', 'cutting', 'cut', 'open', 'opened', 'close', 'closed', 'turn', 'turned', 'start', 'started', 'stop', 'stopped', 'wait', 'waited', 'meet', 'met', 'call', 'called', 'visit', 'visited', 'travel', 'traveled', 'drive', 'drove', 'driven', 'ride', 'rode', 'ridden', 'fly', 'flew', 'flown', 'swim', 'swam', 'swum', 'cook', 'cooked', 'eat', 'ate', 'eaten', 'drink', 'drank', 'drunk', 'sleep', 'slept', 'wake', 'woke', 'woken', 'dream', 'dreamed', 'dreamt', 'sing', 'sang', 'sung', 'dance', 'danced', 'draw', 'drew', 'drawn', 'paint', 'painted', 'build', 'built', 'create', 'created', 'make', 'made', 'fix', 'fixed', 'break', 'broke', 'broken', 'clean', 'cleaned', 'wash', 'washed', 'dry', 'dried', 'cut', 'cutting', 'cut'])
        all_text = ' '.join(entry.content for entry in entries)
        words = re.findall(r"\b\w+\b", all_text.lower())
        filtered = [w for w in words if w not in stop_words and len(w) > 2]
        freq = Counter(filtered)
        wordcloud_data = freq.most_common(30)
