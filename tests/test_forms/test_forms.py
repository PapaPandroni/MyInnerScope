...
from app.forms import LoginForm, RegisterForm, DiaryEntryForm, GoalForm, GoalProgressForm, DeleteAccountForm, ChangeUsernameForm, ChangePasswordForm
...
class TestForms(unittest.TestCase):
    ...
    def test_change_username_form_too_long(self):
        with self.app.test_request_context():
            ...
            self.assertFalse(form.validate())
            self.assertIn('Username must be between 1 and 200 characters', str(form.errors))
